/**
 * ChartView - Formula Results Chart View with 3-Panel Layout (REFACTORED)
 * 
...
export default function ChartView({
	...
	// Handle panel resize - CRITICAL: useCallback prevents infinite loop
	...
	}, [updatePanelLayout]); // Only recreate if updatePanelLayout changes
