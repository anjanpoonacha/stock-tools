...
import { ErrorDisplay, ErrorBoundary } from '@/components/error';
        ...
        <div className='container mx-auto p-6 max-w-4xl'>
            <div className='mb-8'>
                ...
                <p className='text-gray-600 mb-4'>
                    This page tests all error handling components and scenarios to ensure the error system works
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div className='p-4 border rounded-lg bg-white shadow-sm'>
                        ...
                        <ul className='text-sm space-y-1'>
                            ...
                            <li>
                                <code>INVALID_CREDENTIALS</code> - Invalid credentials
                            </li>
                            <li>
                                <code>NETWORK_ERROR</code> - Network connectivity issues
                            </li>
                            <li>
                                <code>API_RATE_LIMITED</code> - API rate limit exceeded
                            </li>
                            <li>
                                <code>OPERATION_FAILED</code> - General operation failures
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='p-4 border rounded-lg bg-white shadow-sm'>
                        ...
                        <ul className='text-sm space-y-1'>
                            ...
                            <li>
                                <code>CRITICAL</code> - Critical failures
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='p-4 border rounded-lg bg-white shadow-sm'>
                        ...
                        <ul className='text-sm space-y-1'>
                            <li>
                                <code>MARKETINOUT</code> - MarketInOut platform
                            </li>
                            <li>
                                <code>TRADINGVIEW</code> - TradingView platform
                            </li>
                            <li>
                                <code>TELEGRAM</code> - Telegram integration
                            </li>
                            <li>
                                <code>UNKNOWN</code> - Unknown platform
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className='p-4 border rounded-lg bg-white shadow-sm'>
                        ...
                        <ul className='text-sm space-y-1'>
                            <li>
                                <code>RETRY</code> - Retry the operation
                            </li>
                            <li>
                                <code>WAIT_AND_RETRY</code> - Wait then retry
                            </li>
                            <li>
                                <code>REFRESH_SESSION</code> - Refresh session
                            </li>
                            <li>
                                <code>RE_AUTHENTICATE</code> - Re-authenticate
                            </li>
                            <li>
                                <code>CLEAR_CACHE</code> - Clear browser cache
                            </li>
                            <li>
                                <code>CHECK_NETWORK</code> - Check network
                            </li>
                            <li>
                                <code>UPDATE_CREDENTIALS</code> - Update credentials
                            </li>
                            <li>
                                <code>CONTACT_SUPPORT</code> - Contact support
                            </li>
                        </ul>
                    </div>
                </div>
