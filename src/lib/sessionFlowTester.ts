...
export class SessionFlowTester {
	...
	private async testCrossPlatformOperations(): Promise<TestSuite> {
		...
		tests.push(await this.runTest('Multi-Platform Session Storage', async () => {
			...
			savePlatformSession(testSessionId, 'tradingview', tvSessionData);
			...
			// Cleanup
			deletePlatformSession(testSessionId, 'marketinout');
			deletePlatformSession(testSessionId, 'tradingview');
...
`;
	...
	async quickHealthCheck(): Promise<{
		...
		try {
			...
			savePlatformSession(testId, 'marketinout', testData);
			results.sessionStore = !!getPlatformSession(testId, 'marketinout');
			deletePlatformSession(testId, 'marketinout');
